          ...
          {selectedTicket ? (
            <>
              ...
              <div style={{ padding: "16px 24px", borderTop: "1px solid var(--color-border)", background: "var(--color-card-bg)", display: "flex", flexDirection: "column", gap: "8px" }}>
                ...
                {replyingToMessage && (
                  <div style={{ display: "flex", alignItems: "center", justifyBox: "space-between", background: "var(--color-bg-subtle)", border: "1px solid var(--color-border)", padding: "8px 12px", borderRadius: "var(--radius-md)", display: "flex", justifyContent: "space-between" }}>
