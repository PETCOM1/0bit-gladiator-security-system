    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "28px", width: "100%" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px" }}>
        ...
        <button 
          ...
          style={{ display: "flex", alignItems: "center", gap: "8px", padding: "10px 16px", background: "var(--color-danger)", color: "#fff", border: "none", borderRadius: "var(--radius-md)", fontWeight: 600, cursor: "pointer", transition: "opacity var(--transition-fast)" }}
      ...
      {showForm && (
        <form onSubmit={handleReport} style={{ background: "var(--color-card-bg)", padding: "24px", borderRadius: "var(--radius-xl)", border: "1px solid var(--color-card-border)", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            ...
            <input type="text" required value={title} onChange={e => setTitle(e.target.value)} placeholder="E.g. Unauthorized access at South Gate" style={inputStyle} />
          </div>
                  ...
                  >
                    ...
                    <td style={{ padding: "16px 24px" }}>
                      <span style={{ 
                        ...
                        background: inc.status === "RESOLVED" || inc.status === "CLOSED" ? "var(--color-success-subtle)" : "var(--color-bg-subtle)", 
                        color: inc.status === "RESOLVED" || inc.status === "CLOSED" ? "var(--color-success)" : "var(--color-text-secondary)" 
                      }}>
                        {inc.status}
                      </span>
                    </td>
