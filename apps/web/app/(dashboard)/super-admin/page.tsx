      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
        ...
        >
          ...
          <div>
            ...
            <h3 style={{ fontSize: "28px", fontWeight: 800, color: "var(--color-text-primary)", margin: 0 }}>R{stats.mrr.toLocaleString()}</h3>
          </div>
        </div>
        ...
        >
          ...
          <div>
            <p style={{ fontSize: "11px", fontWeight: 700, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 4px 0" }}>Active Tenants</p>
            <h3 style={{ fontSize: "28px", fontWeight: 800, color: "var(--color-text-primary)", margin: 0 }}>{stats.activeTenants}</h3>
          </div>
        </div>
        ...
        <div 
          ...
          onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.borderColor = "var(--color-card-border)"; }}
        >
          <div style={iconWrapperStyle("var(--color-info-subtle)", "var(--color-info)")}>
            <Users size={24} />
          </div>
          <div>
            <p style={{ fontSize: "11px", fontWeight: 700, color: "var(--color-text-muted)", textTransform: "uppercase", letterSpacing: "0.06em", margin: "0 0 4px 0" }}>Platform Users</p>
            <h3 style={{ fontSize: "28px", fontWeight: 800, color: "var(--color-text-primary)", margin: 0 }}>{stats.platformUsers}</h3>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "20px 24px", borderBottom: "1px solid var(--color-border)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <h2 style={{ fontSize: "16px", fontWeight: 700, color: "var(--color-text-primary)", margin: 0 }}>Active Tenants Portfolio</h2>
          </div>
              ...
              {paginatedTenants.length === 0 ? (
                <tr>
                  <td colSpan={6} style={{ padding: "60px", textAlign: "center", color: "var(--color-text-muted)", fontSize: "14px" }}>
                    No active tenants matching current filters.
                  </td>
                </tr>
              ) : (
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                      <div>
                        ...
                        <select name="subscriptionPlan" value={formData.subscriptionPlan} onChange={handleChange} style={selectStyle}>
                          <option value="BASIC" style={{ background: "var(--color-card-bg)" }}>Basic</option>
                          <option value="PRO" style={{ background: "var(--color-card-bg)" }}>Pro</option>
                          <option value="ENTERPRISE" style={{ background: "var(--color-card-bg)" }}>Enterprise</option>
                        </select>
                      </div>
                      <div>
  ...
  return (
    <Suspense fallback={
      <div style={{ display: "flex", flex: 1, alignItems: "center", justifyContent: "center", gap: "12px", padding: "80px", color: "var(--color-text-muted)" }}>
        ...
        <span style={{ fontSize: "14px" }}>Loading global admin panel...</span>
      </div>
    }>
